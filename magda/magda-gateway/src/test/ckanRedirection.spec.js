...
const createCkanRedirectionRouter_1 = require("../createCkanRedirectionRouter");
const resCkanDatasetAspect = require("./sampleRegistryResponses/ckanDatasetAspect.json");
const resCkanDatasetQuery = require("./sampleRegistryResponses/ckanDatasetQuery.json");
const resCkanOrganizationQuery = require("./sampleRegistryResponses/ckanOrganizationQuery.json");
const resCkanResource = require("./sampleRegistryResponses/ckanResource.json");
describe("ckanRedirectionRouter router", () => {
    ...
    beforeEach(() => {
        const router = createCkanRedirectionRouter_1.default({
    ...
    createCkanRedirectionRouter_1.genericUrlRedirectConfigs
        .map(config => {
        ...
        if (routerSkip404Test.indexOf(path) !== -1) {
            if (typeof config === "string") {
                ...
                return Object.assign({}, config, { skip404: true });
            }
        }
        return config;
    })
    ...
    describe("Redirect ckan /organization & /organization?q=xxx", () => {
        ...
        it("should redirect /organization?q=xxx&sort=xx&page=xx to /organisations?q=xxx", () => {
            return supertest(app)
                ...
                chai_1.expect(uri.segment(0)).to.equal("organisations");
                const query = uri.search(true);
                chai_1.expect(query.q).to.equal("xxx");
                chai_1.expect(query.sort).be.an("undefined");
                chai_1.expect(query.page).be.an("undefined");
            });
        });
    });
    describe("Redirect /dataset/*", () => {
        ...
        it("should redirect /dataset/unknown-name to /error?errorCode=404&recordType=ckan-dataset&recordId=unknown-name", () => {
            return supertest(app)
                ...
                .expect(303)
                .expect(checkRedirectionDetails("/error?errorCode=404&recordType=ckan-dataset&recordId=unknown-name"));
        });
    });
    describe("Redirect /dataset/*/resource/*", () => {
        ...
        it("should redirect /dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/view/link to /dataset/ds-dga-8beb4387-ec03-46f9-8048-3ad76c0416c8/details", () => {
            return supertest(app)
                .get("/dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/view/link")
                .expect(303)
                .expect(checkRedirectionDetails("/dataset/ds-dga-8beb4387-ec03-46f9-8048-3ad76c0416c8/details"));
        });
        it("should redirect /dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/download/filename.zip to https://ckan.data.gov.au/dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/download/filename.zip ", () => {
            return supertest(app)
                .get("/dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/download/filename.zip")
                .expect(301)
                .expect(checkRedirectionDetails("https://ckan.data.gov.au/dataset/pg_skafsd0_f___00120141210_11a/resource/af618603-e529-4998-b977-e8751f291e6e/download/filename.zip"));
        });
        ...
        it("should redirect /dataset/wrong-ckan-id/resource/wrong-ckan-resource-id to /error?errorCode=404&recordType=ckan-resource&recordId=wrong-ckan-resource-id", () => {
            return supertest(app)
                ...
                .expect(303)
                .expect(checkRedirectionDetails("/error?errorCode=404&recordType=ckan-resource&recordId=wrong-ckan-resource-id"));
        });
    });
    describe("Redirect /organization/:ckanIdOrName", () => {
        it("should redirect /organization/australianbureauofstatistics-geography to /organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5", () => {
            return supertest(app)
                ...
                .expect(303)
                .expect(checkRedirectionDetails("/organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5"));
        });
        ...
        it("should redirect /organization/unknown-name-or-id to /error?errorCode=404&recordType=ckan-organization-details&recordId=unknown-name-or-id", () => {
            return supertest(app)
                ...
                .expect(303)
                .expect(checkRedirectionDetails("/error?errorCode=404&recordType=ckan-organization-details&recordId=unknown-name-or-id"));
        });
    });
    describe("Redirect /organization/datarequest/:ckanIdOrName", () => {
        it("should redirect /organization/datarequest/australianbureauofstatistics-geography to /search?organisation=Australian%20Bureau%20of%20Agriculture%20and%20Resource%20Economics%20and%20Sciences", () => {
            return supertest(app)
                .get("/organization/datarequest/australianbureauofstatistics-geography")
                .expect(303)
                .expect(checkRedirectionDetails("/search?organisation=Australian%20Bureau%20of%20Agriculture%20and%20Resource%20Economics%20and%20Sciences"));
        });
        it("should redirect /organization/datarequest/760c24b1-3c3d-4ccb-8196-41530fcdebd5 to /search?organisation=Australian%20Bureau%20of%20Agriculture%20and%20Resource%20Economics%20and%20Sciences", () => {
            return supertest(app)
                .get("/organization/datarequest/760c24b1-3c3d-4ccb-8196-41530fcdebd5")
                .expect(303)
                .expect(checkRedirectionDetails("/search?organisation=Australian%20Bureau%20of%20Agriculture%20and%20Resource%20Economics%20and%20Sciences"));
        });
    ...
    describe("Redirect /organization/about/:ckanIdOrName", () => {
        it("should redirect /organization/about/australianbureauofstatistics-geography to /organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5", () => {
            return supertest(app)
                .get("/organization/about/australianbureauofstatistics-geography")
                .expect(303)
                .expect(checkRedirectionDetails("/organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5"));
        });
    ...
    describe("Redirect /organization/activity/:ckanIdOrName", () => {
        it("should redirect /organization/activity/australianbureauofstatistics-geography to /organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5", () => {
            return supertest(app)
                .get("/organization/activity/australianbureauofstatistics-geography")
                .expect(303)
                .expect(checkRedirectionDetails("/organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5"));
        });
        it("should redirect /organization/activity/760c24b1-3c3d-4ccb-8196-41530fcdebd5 to /organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5", () => {
            return supertest(app)
                .get("/organization/activity/760c24b1-3c3d-4ccb-8196-41530fcdebd5")
                .expect(303)
                .expect(checkRedirectionDetails("/organisations/org-dga-760c24b1-3c3d-4ccb-8196-41530fcdebd5"));
        });
    ...
    function checkRedirectionDetails(location) {
        return (res) => {
            if (_.isRegExp(location)) {
                chai_1.expect(location.test(res.header["location"])).to.equal(true);
            }
            else {
                chai_1.expect(res.header["location"]).to.equal(location);
            }
        };
    }
    function checkStatusCode(statusCode = 308) {
        return (res) => {
            chai_1.expect(res.status).to.equal(statusCode);
        };
    }
    function testCkanDomainChangeOnly(targetUrlOrUrls, statusCode = 308, allowAllMethod = false) {
        let targetUrls = [];
            ...
            testMethods.forEach(method => {
                ...
                it(caseTitle, () => {
                    ...
                    if (statusCode === 404)
                        ...
                        return test.expect(checkRedirectionDetails(testUri.toString()));
                    }
                });
            });
        });
    }
    function test404(targetUrlOrUrls, allowAllMethod = false) {
        testCkanDomainChangeOnly(targetUrlOrUrls, 404, allowAllMethod);
    }
    function testGenericCkanRedirection(config) {
        const [path, requireExtraSeqment, statusCode, method] = createCkanRedirectionRouter_1.covertGenericUrlRedirectConfigToFullArgList(config);
        ...
        describe(`Redirect CKan URL ${path}`, () => {
            ...
            if (typeof config === "object" && !config.skip404) {
                test404(`https://${ckanRedirectionDomain}${path}xxx`, allowAllMethod);
            }
        });
    }
});
//# sourceMappingURL=ckanRedirection.spec.js.map